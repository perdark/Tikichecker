...
@bot.message_handler(commands=['start'])def start_message(message): first = message.from_user.first_name url = 'https://t.me/N1111V/3' bot.send_animation((message.chat.id), url, caption=f"""اهلا {first} في بوت يوزرات تلجرام 🚹اضغط /TXN لنتائكد انك مشترك في البوت 👁️للشتراك في البوت اذا كنت غير مشترك @E_4_1 ⚠️""", reply_to_message_id=(message.message_id))
